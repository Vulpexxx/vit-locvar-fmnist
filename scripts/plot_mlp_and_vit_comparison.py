...
mlp_A_A_acc      = [64.33, 68.48, 69.13, 70.48, 70.92, 72.27, 72.15, 72.08, 72.06, 72.28, 72.70, 71.96, 72.72, 72.90, 71.48]
...
# Plot configurations
plt.plot(epochs, mlp_A_A_acc, label='MLP (ReLU): Train A / Val A', marker='o', linestyle='-', color='#1f77b4')
plt.plot(epochs, vit_gelu_A_A_acc, label='ViT (GELU): Train A / Val A', marker='s', linestyle='-', color='#ff7f0e')

# Format plot area
plt.title('MLP vs ViT on Setting 1 (A→A)')
plt.xlabel('Epochs')
