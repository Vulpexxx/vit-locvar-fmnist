...
def plot_patch_feature_comparison(save_path: str) -> None:
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Plot patch feature and patch size comparison curves.")
    parser.add_argument("--save-path", default="../visualizations/patch_feature_and_patch_size_comparison.png", help="Output image path.")
    return parser.parse_args()


if __name__ == "__main__":
    args = parse_args()
    plot_patch_feature_comparison(args.save_path)
